...
(() => {
  ...
  // node_modules/.pnpm/countup.js@2.7.0/node_modules/countup.js/dist/countUp.min.js
  var t = function() {
  ...
  var listingSlider = new core_default(".listing-slider", {
    slidesPerView: 3.5,
    spaceBetween: 30,
    grabCursor: true,
    loop: true,
  ...
  var servicesLinks = document.querySelectorAll(".services_link-inner");
  var servicesTitle = document.querySelectorAll(".services_title");
  servicesTitle.forEach((el) => {
    const words = el.innerHTML.split(" ");
    words[0] = `<span class="span-red">${words[0]}</span>`;
    el.innerHTML = words.join(" ");
  });
  var heroWords = new core_default(".hero-words", {
    direction: "vertical",
    slidesPerView: 1,
    // spaceBetween: 30,
    mousewheel: true,
  ...
  var heroSubWords = new core_default(".hero-sub-words", {
    direction: "vertical",
    slidesPerView: 1,
    // spaceBetween: 30,
    mousewheel: true,
  ...
  var team = new core_default("[data-slider-team]", {
    slidesPerView: 1.3,
    spaceBetween: "30",
  ...
  gsapWithCSS.from(".listing-slider .swiper-slide", {
    duration: 0.6,
    autoAlpha: 0,
    stagger: {
      amount: 0.5
  ...
  gsapWithCSS.from(".services_link-inner", {
    duration: 0.6,
    autoAlpha: 0,
    stagger: 0.1,
    filter: "blur(5px)",
  ...
  var statBlocks = document.querySelectorAll(".stats_block-number");
  statBlocks.forEach((block) => {
    const blockElement = block;
    const endValue = Number(blockElement.textContent);
    const countUp = new i(blockElement, endValue, {
      enableScrollSpy: true,
      duration: 2,
      scrollSpyDelay: 500
    });
  });
  gsapWithCSS.from(".stats_block", {
    duration: 0.6,
    autoAlpha: 0,
    stagger: {
      from: "random",
  ...
  var bloglistSlder = new core_default("[data-slider-bloglist]", {
    slidesPerView: 3.5,
    spaceBetween: 30,
    grabCursor: true,
    autoplay: {
